      ...
      <section className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 space-y-6">
          <h2 className="text-5xl font-bold leading-tight text-gray-900">
            ...
            <span className="text-primary">экспертные ответы</span>
          </h2>
          <p className="text-xl text-gray-600">
            Наша платформа соединяет людей с вопросами и экспертов с ответами.
            Получите решение ваших проблем быстро и эффективно.
          </p>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1 text-sm text-gray-500">
                      ...
                      <span className="flex items-center gap-1">
                        ...
                        {question.answers} ответов
                      </span>
                      <span className="flex items-center gap-1">
                        <Icon name="Eye" className="h-3 w-3" /> {question.views}{" "}
                        просмотров
                      </span>
                    </div>
                  </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Наша платформа предлагает уникальные возможности для поиска ответов
            и обмена знаниями
          </p>
        </div>
      ...
      <section className="bg-primary/5 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Готовы найти ответы на ваши вопросы?
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Присоединяйтесь к тысячам пользователей, которые уже нашли решения
            своих проблем на QuestionHub
          </p>
          <Link
            to="/questions"
            className="inline-flex items-center bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-md transition-colors"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Платформа для вопросов и ответов, которая соединяет людей с
                экспертами
              </p>
            </div>
            <div>
...
const popularQuestions = [
  ...
  {
    title:
      "Какие библиотеки React лучше всего подходят для создания дашбордов?",
    userName: "Павел К.",
    userAvatar:
      "https://images.unsplash.com/photo-1600486913747-55e5470d6f40?q=80&w=250",
    answers: 8,
    views: 216,
  },
  {
...
const features = [
  {
    ...
    description:
      "Тысячи квалифицированных специалистов готовы поделиться своими знаниями",
  },
  {
    icon: "Zap",
  ...
  },
  {
    ...
    description:
      "Система оценки качества ответов помогает находить лучшие решения",
  },
];
