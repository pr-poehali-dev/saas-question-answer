      ...
      <div className="flex">
        ...
        {!compact && (
          <div className="flex flex-col items-center p-4 bg-gray-50 border-r border-gray-100">
            <div
              className={`cursor-pointer flex items-center justify-center h-8 w-8 rounded-full ${userVote === "up" ? "text-primary bg-primary/10" : "text-gray-400 hover:text-primary"}`}
            ...
            <div
              className={`cursor-pointer flex items-center justify-center h-8 w-8 rounded-full ${userVote === "down" ? "text-destructive bg-destructive/10" : "text-gray-400 hover:text-destructive"}`}
        ...
        <div className="flex-1">
          <CardHeader className={compact ? "py-3 px-4" : "p-4"}>
            <div className="flex justify-between items-start gap-4">
              <Link
                ...
                className="font-semibold text-gray-900 text-lg group-hover:text-primary transition-colors"
              >
                {question.title}
              </Link>
              {compact && (
                <div className="flex items-center gap-1">
                  <div
                    className="cursor-pointer flex items-center justify-center h-6 w-6 text-gray-400 hover:text-primary"
                    onClick={() => handleVote("up")}
                  >
          ...
          <CardFooter
            className={`${compact ? "pt-1 pb-3 px-4" : "px-4 py-3"} flex flex-wrap justify-between`}
          >
